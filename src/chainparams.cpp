...
{
    const char* pszTimestamp = "Why Are Altcoins Falling Faster Than Bitcoin? - Investopedia";
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x212f38bb71a448c33f3486b0274870d69b671ef0e042ff3d18a37f0d2c047310"); //534292
        ...
        genesis = CreateGenesisBlock(1617601470, 2021040516, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x212f38bb71a448c33f3486b0274870d69b671ef0e042ff3d18a37f0d2c047310"));
        assert(genesis.hashMerkleRoot == uint256S("0xc3e14e7a4c2c520250174e7338ae083c2d05549a7eb42d76bedbffcc40f796f2"));
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x147a88a505aa654d70549b0a66f8a9b6b5b6c800b9c509d3c84755b3d3c71a3d"); //534292
